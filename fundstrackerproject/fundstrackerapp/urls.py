...
urlpatterns = [
    ...
    # path('account/updateincome/<int:income_id>/', expense_edit_form, name='expense_edit_form'),
    # path('account/updateincome/<int:income_id>/', expense_details, name='expense_details'),
]
